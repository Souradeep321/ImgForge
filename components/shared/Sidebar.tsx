        ...
        <nav className="flex h-full flex-col justify-between md:gap-4">
          <SignedIn>
                ...
                return (
                  <li
                    ...
                    className={`flex w-full items-center justify-center whitespace-nowrap rounded-full transition-all hover:bg-purple-100 hover:shadow-inner group ${isActive
                      ? 'bg-purple-400 bg-cover text-white'
                      : 'text-gray-700'
                      }`}
                  >
                    <Link
            ...
            <ul className="hidden w-full flex-col items-start gap-2 md:flex">
              ...
              <li className="flex items-center justify-center cursor-pointer gap-4 p-4  w-full">
                <UserButton showName  />
              </li>
          ...
          <SignedOut>
            <Button
              asChild
              className="flex items-center justify-center gap-3 rounded-full px-6 py-4 focus-visible:ring-offset-0 focus-visible:ring-transparent bg-purple-300 bg-cover "
            >
              <Link href="/sign-in"> 
